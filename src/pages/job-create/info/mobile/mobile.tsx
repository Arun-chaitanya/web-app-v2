...
import { setPostPaymentScheme, setPostPaymentType } from '@store/reducers/createPostWizard.reducer';
import { setQuestionProjectIds } from '@store/reducers/createQuestionWizard.reducer';
